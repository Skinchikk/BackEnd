...
require_once '../models/ProducersList.php';
require_once '../dbconnect.php';

$pl = new ProducersList();
$pl -> getAllFromDB($conn);
if (isset($_GET['action']) && $_GET['action'] === 'delete') {
    $pl->deleteFromDB($conn, $_GET['id']);
...
<html>
    ...
    <body>
        <div class="container">
            ...
            <a class="btn btn-primary" href="AddProducer.php">Add producer</a>
            <div>
                <table class="table">
                    <thead>
                        <tr>
                    ...
                    <tbody> <?php echo $pl->exportAsTableData();?> </tbody>
                </table>
            </div>
        </div>
    </body>
