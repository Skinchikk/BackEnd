...
require_once '../models/Coffee_typesList.php';
require_once '../dbconnect.php';
$ctl = new Coffee_typesList();
$ctl -> getAllFromDB($conn);
if (isset($_GET['action']) && $_GET['action'] === 'delete') {
    $ctl->deleteFromDB($conn, $_GET['id']);
...
<html>
    ...
    <body>
        <div class="container">
            ...
            <a class="btn btn-primary" href="AddCoffeeType.php">Add coffee type</a>
            <div>
                <table class="table">
                    <thead>
                        <tr>
                    ...
                    <tbody> <?php echo $ctl->exportAsTableData();?> </tbody>
                </table>
            </div>
        </div>
    </body>
